...
-- B1	=>  Location: PIN_R2,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- B3	=>  Location: PIN_P6,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- B4	=>  Location: PIN_V11,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF BloqueX IS
...
-- Equation(s):
-- \inst~combout\ = \S1~input_o\ $ (\B1~input_o\ $ (\S0~input_o\))
...
-- Equation(s):
-- \inst1~combout\ = \B2~input_o\ $ (\S0~input_o\ $ (\S1~input_o\))
...
-- Equation(s):
-- \inst2~combout\ = \S1~input_o\ $ (\B3~input_o\ $ (\S0~input_o\))
...
-- Equation(s):
-- \inst3~combout\ = \S1~input_o\ $ (\S0~input_o\ $ (\B4~input_o\))
